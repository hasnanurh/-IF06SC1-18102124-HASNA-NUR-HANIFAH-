...
import com.hasnanurhanifah_18102124.praktikum9.databinding.ActivitySettingPreferenceBinding
import com.hasnanurhanifah_18102124.praktikum9.preferences.SettingPreference
...
class SettingPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(p0: View?) {
        if (p0?.id == R.id.btn_save) {
            ...
            saveSetting(name, email, age, phoneNo, hobi, address, isLoveMU)
    ...
    private fun saveSetting(name: String, email: String, age: String, phoneNo: String, hobi: String, address: String, isDark: Boolean) {
