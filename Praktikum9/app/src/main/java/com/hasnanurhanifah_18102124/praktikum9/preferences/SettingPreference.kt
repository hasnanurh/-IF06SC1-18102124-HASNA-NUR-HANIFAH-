package com.hasnanurhanifah_18102124.praktikum9.preferences
...
import com.hasnanurhanifah_18102124.praktikum9.data.SettingModel
    ...
    internal class SettingPreference(context: Context) {
        ...
        fun setSetting(value: SettingModel) {
            ...
            editor.putString(HOBBY,value.hobi)
        ...
        fun getSetting(): SettingModel {
            ...
            model.hobi = preferences.getString(HOBBY, "")
